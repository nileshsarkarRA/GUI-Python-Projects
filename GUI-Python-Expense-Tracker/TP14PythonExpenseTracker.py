## A useful GUI version of Python Expense Tracker by Team Achievers
...
def edit_expense():
	...
	edit_btn = Button(data_entry_frame, text='Edit expense', font=btn_font, width=30,
	                  bg=hlb_btn_bg, command=edit_existing_expense, pady=12, padx=12)
...
dataentery_frame_bg = 'lightgreen'
buttons_frame_bg = 'lightblue'
hlb_btn_bg = 'Green'

lbl_font = ('Ariel', 13)
entry_font = 'Times 13 bold'
btn_font = ('Times_New_Roman', 13)

# Initializing the GUI window
root = Tk()
root.title('Expense Tracker by Team Achievers')
root.geometry('1200x550')
root.resizable(0, 0)

Label(root, text='GUI EXPENSE TRACKER', font=('Ariel', 14, 'bold'), bg=hlb_btn_bg).pack(side=TOP, fill=X)
...
Button(buttons_frame, text='Clear Fields in Entry Frame', font=btn_font, width=25, bg=hlb_btn_bg,
